...
files = ['/home/a1705053/Desktop/merged_codes_may22/output/exoclass_tests/test1_merged_exo_recfast_cl.dat', '/home/a1705053/Desktop/merged_codes_may22/output/exoclass_tests/test1_separate_exo_recfast_cl.dat']
data = []
for data_file in files:
    data.append(np.loadtxt(data_file))
roots = ['test1_merged_exo_recfast_cl', 'test1_separate_exo_recfast_cl']
