...
files = ['/home/a1705053/Desktop/merged/merged_codes_may22/output/thesis/lcdm_cl.dat', '/home/a1705053/Desktop/merged/merged_codes_may22/output/sec/lcdm_cl.dat']
data = []
for data_file in files:
    data.append(np.loadtxt(data_file))
roots = ['lcdm_cl', 'lcdm_cl']
