...
color = ['red','blue', 'green','chocolate', 'orangered', 'orchid', 'orange', 'magenta','red']
...
ax.set_xlabel('$\ell$', fontsize=21)
ax.set_xlim(3,2700)

# ax[0].annotate(r'$\Gamma_{wdm}^{-1} = 55 Gyr$', xy=(10.5, 8e-10))
ax.tick_params(labelsize=21)

plt.ylabel(r'$\frac{C_\ell^\mathrm{TT}(\Lambda\mathrm{DDM})}{C_\ell^\mathrm{TT}(\Lambda \mathrm{CDM})}-1$',fontsize=23)
...
plt.legend([r'$\Lambda$CDM', r'Modified CLASS(2023) $(10^{22}s)$',r'ExoCLASS $(10^{22}s)$'], fontsize=19, loc='upper left', framealpha=0.1)
# plt.title(r'Exoclass vs Merged Code', loc='center')
# plt.savefig("residual_2_gamwdm1e-10kmsMpc.pdf", format="pdf")
plt.savefig("chap5merged_test.pdf", format="pdf")
