...
files = ['/home/a1705053/Desktop/merged_codes_may22/output/test1_exo_only_cl.dat', '/home/a1705053/Desktop/merged_codes_may22/output/explanatory00_cl.dat']
data = []
for data_file in files:
    data.append(np.loadtxt(data_file))
roots = ['test1_exo_only_cl', 'explanatory00_cl']
