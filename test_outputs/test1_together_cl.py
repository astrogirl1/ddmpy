...
files = ['/home/a1705053/Desktop/merged_codes_may22/output/test1_together_cl.dat', '/home/a1705053/Desktop/merged_codes_may22/output/explanatory01_cl.dat']
data = []
for data_file in files:
    data.append(np.loadtxt(data_file))
roots = ['test1_together_cl', 'explanatory01_cl']
