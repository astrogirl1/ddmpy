...
double dEdtdV_DM_decay(double z, INJ_PARAMS *params){
  ...
  if(params->decay_fraction>0){
     ...
     result_integrale = exp(-params->Gamma_dcdm_exo*2*((params->Omega0_b+params->Omega0_cdm)*pow(params->Omega0_r+(params->Omega0_b+params->Omega0_cdm)/(1+z),0.5)
    ...
    energy_rate=rho_cdm_today*pow((1+z),3)*params->decay_fraction*result_integrale*(params->Gamma_dcdm_exo*2.99792458e8/_Mpc_over_m_)/1.e6/1.60217653e-19;
    // if(rho_ini_dcdm!=0)energy_rate=rho_ini_dcdm*pow((1+z),3)*param->decay*result_integrale*(param->Gamma_dcdm_exo*2.99792458e8/_Mpc_over_m_)/1.e6/1.60217653e-19;
    // // else energy_rate=rho_cdm_today*pow((1+z),3)*param->decay/1.e6/1.60217653e-19;
    // else energy_rate=rho_cdm_today*pow((1+z),3)*param->decay*result_integrale*(param->Gamma_dcdm_exo*2.99792458e8/_Mpc_over_m_)/1.e6/1.60217653e-19;
