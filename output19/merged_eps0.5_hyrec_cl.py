...
files = ['/home/a1705053/Desktop/merged/merged_codes_may22/output19/merged_eps0.5_hyrec_cl.dat', '/home/a1705053/Desktop/1908/class_decays/output/eps0.5_hyrec_cl.dat']
data = []
for data_file in files:
    data.append(np.loadtxt(data_file))
roots = ['merged_eps0', 'eps0']
